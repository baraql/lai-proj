...
And run: 
```bash
$ python loss_ablation.py --fsdp-logs=/users/username/scratch/lai-proj/logs/loss_ablation_fsdp/lsai-454149.out --no-fsdp-logs=/users/username/scratch/lai-proj/logs/loss_ablation_no_fsdp/lsai-454162.out
```
